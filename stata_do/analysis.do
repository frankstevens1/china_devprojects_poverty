...
* summary statistics
estpost summarize iwipov50 total_d oda_d transport_d total oda transport steel ln_steel /// 
...
esttab . using sumstatx.rtf, cells("count mean sd min max") nonumber noobs replace
...
esttab model1 model2 model3 model4 model5 model6 using table1x.rtf, ///
...
cd C:\Users\fstev\china_devprojects_poverty\tables
estfe model*, labels(gdlcode "Region FE" year "Year FE")
esttab model7 model8 model9 model10 model11 model12 using table2x.rtf, ///
 replace indicate(`r(indicate_fe)') nocons obslast compress se /// 
...
* Table 10: Predicted values < 0
cd C:\Users\fstev\china_devprojects_poverty\tables
estfe model*, labels(gdlcode "Region FE" year "Year FE")
esttab model9 model13 using check.rtf, ///
 replace indicate(`r(indicate_fe)') nocons obslast compress se /// 
 star(* 0.10 ** 0.05 *** 0.01 **** 0.001) scalars(rkf N_clust N_full) order(L.iwipov50)
...
cd C:\Users\fstev\china_devprojects_poverty\tables
esttab . using sumstat_isox.rtf, cells("count mean sd min max") nonumber noobs replace
...
esttab model1 model2 model3 model4 model5 model6 using table3x.rtf, ///
 replace indicate(`r(indicate_fe)') nocons obslast compress se ///
...
estimates store model12
** B5. Robustness check (addition of FDI)
...
cd C:\Users\fstev\china_devprojects_poverty\tables
estfe model*, labels(country "Country FE" year "Year FE")
esttab model7 model8 model9 model10 model11 model12 model13 using table4x.rtf, ///
 replace indicate(`r(indicate_fe)') nocons obslast compress se /// 
...
cd C:\Users\fstev\china_devprojects_poverty\tables
estfe model*, labels(gdlcode "Region FE" year "Year FE")
esttab model1 model2 model3 model4 model5 model6 model7 model8 using table5x.rtf, ///
 replace indicate(`r(indicate_fe)') nocons obslast compress se /// 
 star(* 0.10 ** 0.05 *** 0.01 **** 0.001) scalars(rkf N_clust N_full) order(L.iwipov50)
...
* Table 6: 2SLS (Amounts & Counts Regressions)
cd C:\Users\fstev\china_devprojects_poverty\tables
estfe model*, labels(gdlcode "Region FE" year "Year FE")
esttab model1 model2 model3 model4 model5 model6 using table6x.rtf, ///
 replace indicate(`r(indicate_fe)') nocons obslast compress se /// 
 star(* 0.10 ** 0.05 *** 0.01 **** 0.001) scalars(rkf N_clust N_full) order(L.iwipov50)
